...
Reconsider the question on the Old Faithful eruptions on the last homework. Remember the data inlcuded a variable for the day of the eruptions (called "Date" in the dataset).  
    *Use the same "OldFaithful.csv" file you used for the first homework.*
      + Fit a regression of Interval on Duration and Day (treated as a factor variable).
