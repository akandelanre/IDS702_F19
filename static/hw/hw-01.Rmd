...
This assignment involves linear regression with one predictor. The data can be found under the assignments tab (check the corresponding assignment item) on Sakai. Please type your solutions using R Markdown, LaTeX or any other word processor.
