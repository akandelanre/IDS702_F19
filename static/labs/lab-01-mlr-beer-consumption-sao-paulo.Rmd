...
The purpose of this lab is to give you more practice working with linear regression with multiple predictors. You will also write your own code for doing k-fold cross validation. The lab is based on the following Kaggle beer cosumption dataset: [https://www.kaggle.com/dongeorge/beer-consumption-sao-paulo/](https://www.kaggle.com/dongeorge/beer-consumption-sao-paulo/)
