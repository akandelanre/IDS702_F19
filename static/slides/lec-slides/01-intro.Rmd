...
<i class="fa fa-calendar"></i> &nbsp; Mon and Wed 3:00 - 4:00pm
...
<i class="fa fa-university"></i> &nbsp; [Gross Hall](https://maps.duke.edu/?id=21#!m/6866?s/Gross%20Hall) <br>
<i class="fa fa-calendar"></i> &nbsp; TBD

<br>

[TBD](https://akandelanre.github.io/IDS702_F19/)

<i class="fa fa-envelope"></i> &nbsp; [TBD](mailto:walker.harrison@duke.edu) <br>
<i class="fa fa-university"></i> &nbsp; [Gross Hall](https://maps.duke.edu/?id=21#!m/6866?s/Gross%20Hall) <br>
<i class="fa fa-calendar"></i> &nbsp; TBD
...
- The methods are best learned by practical data analysis so, lots of learn-by-doing.
...
- Ask as many questions as possible during and outside classes; there are no stupid questions!
...
- Class attendance is a firm expectation!
...
- Assignments should be turned in using a typesetting system such as LaTeX or R Markdown.
...
- Lab assigments are meant to give you more hands-on experience with data analysis using R. 
...
- Attendance is not mandatory, however, each lab assigment should be submitted in timely fashion on the due date.
