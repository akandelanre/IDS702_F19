...
- Then,
  + For any $j$, $\beta_{1}$ is the log-odds of a Democrat, when compared to a Republican, of being more liberal than $j$ compared to being more conservative than $j$.
  + For any $j$, $e^{\beta_{1}}$ is the odds of a Democrat, when compared to a Republican, of being more liberal than $j$ compared to being more conservative than $j$.
  
- If $\beta_{1} > 0$, a Democrat's response is more likely than a Republican's response to be in the liberal direction than in the conservative direction.
...
# In-class analysis: move to the R script [here](https://akandelanre.github.io/IDS702_F19/slides/lec-slides/Political.R)
