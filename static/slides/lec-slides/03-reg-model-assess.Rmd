...
- This value will be small when our predictions $\hat{y}_i$ are close to the true $y_i$'s. 
...
- We may be able to identify this problem when comparing the out-of-sample MSEs of different models (including the parsimonous models).
