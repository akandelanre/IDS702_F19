...
- Split into your assigned teams.

- Open the in-class assessment for today on the website (check under HW).

- Discuss the questions and document your responses in 15 minutes.

- Now open the assessment key. On the website, just go back to the class schedule, refresh the page, and click the same HW link. 

- Discuss the responses in 10 minutes. Which questions did you get wrong and why.
