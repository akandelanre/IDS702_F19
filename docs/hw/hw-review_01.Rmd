...
date: "Due beginning of class, Thursday, August 29"
output: 
  html_document: 
    css: hw.css
    theme: yeti
...
1. For a given standard error, lower confidence levels produce wider confidence intervals.
  ...
  8. It is necessary that the distribution of the variable itself follows a normal curve.
  ...
  10. If you make go through life making 99% confidence intervals for all sorts of population means, about 1% of the time the intervals won't cover their respective population means. 
